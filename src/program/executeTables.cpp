...
//    for (size_t i = 0; i < sizeof(updateTableArr) / sizeof(updateTableArr[0]); i++) {
...
//    al::ExecuteTable updateExecTable{};
//    updateExecTable.mName = tableName;
//    int startIndex = getUpdateTableIndex(startListName);
//    updateExecTable.mExecuteOrders = &updateTableArr[startIndex];
//    updateExecTable.mExecuteOrderCount = (getUpdateTableIndex(endListName) - startIndex) + 1;
//    return updateExecTable;
//}
//
//static constexpr int getDrawTableIndex(const char* listName, const char *groupName) {
//    for (size_t i = 0; i < sizeof(drawTableArr)/sizeof(drawTableArr[0]); i++) {
...
//    al::ExecuteTable drawExecTable{};
//    drawExecTable.mName = tableName;
//    int startIndex = getDrawTableIndex(startListName, groupStartName);
//    drawExecTable.mExecuteOrders = &drawTableArr[startIndex];
//    drawExecTable.mExecuteOrderCount = (getDrawTableIndex(endListName, groupEndName) - startIndex) + 1;
//    return drawExecTable;
//}
//
