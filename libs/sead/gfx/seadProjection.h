...
namespace sead {
    ...
    public:
        OrthoProjection();
        OrthoProjection(f32 near, f32 far, sead::Viewport const&);
        OrthoProjection(f32 near, f32 far, sead::BoundBox2<float> const&);
        OrthoProjection(f32 near, f32 far, f32, f32, f32, f32);
