...
namespace al {
  ...
  void calcVelocityKeepLengthBetweenActor(sead::Vector3f*, const al::LiveActor* actor, const al::LiveActor* target, f32,
                                          f32);
  ...
  f32 calcDistance(const al::LiveActor* actor, const sead::Vector3f&);
  f32 calcDistanceV(const al::LiveActor* actor, const al::LiveActor* target);
  f32 calcDistanceH(const al::LiveActor* actor, const al::LiveActor* target);
  f32 calcDistanceH(const al::LiveActor* actor, const sead::Vector3f&, const sead::Vector3f&);
  ...
  void walkAndTurnToDirectionFittedGroundGravity(al::LiveActor* actor, sead::Vector3f*, const sead::Vector3f&, f32, f32,
                                                 f32, f32, bool);
