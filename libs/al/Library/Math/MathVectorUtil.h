...
namespace al {
  ...
  void calcDistanceVecToPlane(sead::Vector3f const&, sead::Vector3f const&, sead::Vector3f const&,
                              sead::Vector3f const&);
  ...
  void calcNearVecFromAxis3(sead::Vector3f*, sead::Vector3f const&, sead::Vector3f const&, sead::Vector3f const&,
                            sead::Vector3f const&);
  ...
  void turnQuatWithAxisDegree(sead::Quatf*, sead::Quatf const&, sead::Vector3f const&, sead::Vector3f const&,
  ...
  void rotateQuatAndTransDegree(sead::Quatf*, sead::Vector3f*, sead::Quatf const&, sead::Vector3f const&,
                                sead::Vector3f const&, sead::Vector3f const&, float);
  ...
  void turnVecToVecCos(sead::Vector3f*, sead::Vector3f const&, sead::Vector3f const&, float, sead::Vector3f const&,
                       float);
  void turnVecToVecCosOnPlane(sead::Vector3f*, sead::Vector3f const&, sead::Vector3f const&, sead::Vector3f const&,
                              float);
  void turnVecToVecCosOnPlane(sead::Vector3f*, sead::Vector3f const&, sead::Vector3f const&, float);
  void rotateVectorCenterDegree(sead::Vector3f*, sead::Vector3f const&, sead::Vector3f const&, sead::Vector3f const&,
                                float);
