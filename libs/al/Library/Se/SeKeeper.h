...
namespace al {
    ...
    class SeKeeper {
    public:
        static void create(const al::AudioSystemInfo*, al::SeDirector*, const char*, const sead::Vector3f*,
                           const sead::Matrix34f*, const al::ModelKeeper*, al::CameraDirector*);
        SeKeeper(const al::AudioSystemInfo*, al::SeDirector*, const char*, const sead::Vector3f*,
                 const sead::Matrix34f*, const al::ModelKeeper*, al::CameraDirector*);
        ...
        void tryRequestPlaySe(const char*, float, const char*, const al::SePlayParamList*, const al::MeInfo*, bool,
                              const char*, const sead::Vector3f*);
